	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				'inner-glass': 'inset 0 1px 0 hsl(0 0% 100% / 0.08)'
			},
			backdropBlur: {
			...
			animation: {
				...
				'float-in-down': 'float-in-down 0.55s cubic-bezier(0.16, 1, 0.3, 1)',
				'float-in-side': 'float-in-side 0.58s cubic-bezier(0.16, 1, 0.3, 1)',
